...
/*** REGION 1 - Global variables - Vùng khai báo biến, hằng số, tham số TOÀN CỤC */
    ...
    var gOrderInfor = {
        ...
        actualPrice: function(){
            var vActualPriceVND = this.menu.priceVND * (1 - (this.discount * 0.01));
...
/*** REGION 4 - Common funtions - Vùng khai báo hàm dùng chung trong toàn bộ chương trình*/
    ...
    function displayInforToModal(paramOrderObj){
        ...
        $("#area-detail").val(
           "Xác nhận: " + paramOrderObj.hoVaTen + ", " + paramOrderObj.soDienThoai + ", " + paramOrderObj.diaChi + "\n"
           + "Menu: Combo " + paramOrderObj.menu.pizzaSize + ", Đường kính(cm) " + paramOrderObj.menu.duongKinh + ", Sườn(miếng) " + paramOrderObj.menu.suon
           + ", Salad(gr) " + paramOrderObj.menu.salad + ", Số lượng nước " + paramOrderObj.menu.drink +"\n"
           + "Loại pizza: " + paramOrderObj.loaiPizza + ", Giá: " + paramOrderObj.menu.priceVND + ", Mã giảm giá: " + paramOrderObj.voucher + ", Loại nước " + paramOrderObj.drink + "\n"
           + "Phải thanh toán " + paramOrderObj.actualPrice() + " VND " + " (Giảm giá " + paramOrderObj.discount + "%)"
            );
    }
    ...
    function callApiGetVoucherByVoucherCode(paramOrderObj){
        ...
        $.ajax({
            ...
            error: function(ajaxContext){
                console.log("Voucher không tồn tại, hãy thử với mã giảm giá khác");
                paramOrderObj.discount = 0;
            }
        });
    }
    ...
    function callApiGetAllDrink(){
        ...
        $.ajax({
            ...
            error: function(ajaxContext){
                console.log("Lấy dữ liệu nước uống thất bại " + ajaxContext.responseText);
            }
        });
    }
    ...
    function getPizza(paramPizzaSize, paramDuongKinh, paramSuon, paramSalad, paramDrink, paramPrice){
        "use strict"
        var vComboObj = {
